                        ...
                        <form className="mt-8 grid grid-cols-6 gap-6">
                            ...
                            <div className="col-span-6">
                                ...
                                <input
                                    ...
                                    id="Email"
                                    name="email"
                                    className="mt-1 p-3 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                                />
                            </div>
                            {/*password*/}
                            <div className="col-span-6">
